    ...
    >
      <div className="container pt-12 flex items-center">
        <div>
          ...
          <p className="text-[#312DFF]">Real life problem solving</p>
          <h1 className="text-[36px] font-bold">{data?.title}</h1>
          <p className="py-4">{data?.description}</p>
          <p>Organizer: {data?.organization?.name} </p>
          <div className="flex items-start gap-2 py-4">
            ...
            <Image
              ...
              width={44}
            />
            +1234 participant have join this challenge
          </div>
          <Button type="primary" class_name="px-16">
            Start Project
          </Button>
        </div>
        <div>
